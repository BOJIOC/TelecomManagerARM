...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnReference = findViewById(R.id.btnReference); // Инициализация кнопки справочника
        ...
        btnReference.setOnClickListener(v -> navigateToActivity(ReferenceActivity.class)); // Обработчик для кнопки справочника
    }
